 ...
 */
class getYRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\YRepository' shared autowired service.
     *
     * @return \App\Repository\YRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'YRepository.php';

        return $container->privates['App\\Repository\\YRepository'] = new \App\Repository\YRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
